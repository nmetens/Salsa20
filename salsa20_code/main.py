...
def view_trace_file(path="salsa20_trace.txt"):
    """
    Display the Salsa20 round-by-round trace generated by trace_salsa20_rounds().
    Nicely prints the file with separators for readability.
    """
    try:
        ...
        print(f"[!] Trace file '{path}' not found. Make sure you ran trace_salsa20_rounds().")
